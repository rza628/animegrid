...
<div class="container">
  ...
  <Modal gridTile={1} {categories} />
  <Modal gridTile={2} {categories} />
  <Modal gridTile={3} {categories} />

  <button class="downTopic">{categories[4]}</button>
  <Modal gridTile={4} {categories} />
  <Modal gridTile={5} {categories} />
  <Modal gridTile={6} {categories} />
  <button class="downTopic">{categories[5]}</button>
  <Modal gridTile={7} {categories} />
  <Modal gridTile={8} {categories} />
  <Modal gridTile={9} {categories} />
</div>
